      ...
      <main>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 max-w-3xl space-y-12">
            <FadeIn>
              <h2 className="text-2xl lg:text-3xl font-serif font-medium text-foreground mb-4">Why we exist</h2>
            ...
            <FadeIn delay={0.05}>
              <h2 className="text-2xl lg:text-3xl font-serif font-medium text-foreground mb-4">Our founder's note</h2>
              <Card className={`bg-muted/40 ${cardFeatured}`}>
        ...
        <section className="relative bg-navy py-16 overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 text-center">
            <FadeIn>
              <h2 className="text-2xl lg:text-4xl font-serif font-medium text-white mb-3">Have questions for us directly?</h2>
              <Button
                size="lg"
