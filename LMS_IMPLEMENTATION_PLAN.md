...
- **Phase 5 — Student profile page: shipped**, `feature/student-profile` branch, no migration needed (the `profiles` "editable by owner" policy already covered this). `/dashboard/profile` — edit name/phone, change password. Now moving to Phase 6 (announcements).
